...
void MFCustomDevice::attach(uint16_t adrPin, uint16_t adrType, uint16_t adrConfig, bool configFromFlash)
{
    ...
    ********************************************************************************** */
    ...
    if (strcmp(parameter, "Vertical_Speed_Indicator") == 0)
        _customType = VSI_DEVICE_1;

    if (_customType == VSI_DEVICE_1) {
        /* **********************************************************************************
            Check if the device fits into the device buffer
        ********************************************************************************** */
        if (!FitInMemory(sizeof(Vertical_Speed_Indicator))) {
        ...
        ********************************************************************************** */
        ...
        _myVSIdevice = new (allocateMemory(sizeof(Vertical_Speed_Indicator))) Vertical_Speed_Indicator(_pin1, _pin2);
